class Client:
    ...
    from ._HuobiC_ import Huobi_Functions as Huobi
    from ._KrakenC_ import Kraken_Functions as Kraken
...
class Web_Client:
    ...
    from ._HuobiC_ import Huobi_Web_Functions as Huobi
    from ._KrakenC_ import Kraken_Web_Functions as Kraken